...
export class PublicationsComponent {
  ...
  publications: any = [
    ...
    },
    {
      ...
      description: ['Este trabajo, es una recopilación de datos históricos, que a través de un excelente trabajo ' +
      'fotográfico sobre el Patrimonio Cultural , hace un sucinto recorrido por la particular historia de laGuaira , ' +
      'y evidencia las circunstancias que formaron a los guaireños como sociedad, desde sus más lejanas raíces, ' +
    ...
    },
    {
      ...
      'Alternativas. Las Experiencias amazónicas como base de la Red de Tecnologías Apropiadas de la Amazonia –RETAM ' +
      '(amazonia de Bolivia, Brasil, Colombia y Venezuela)',
      author: 'Ruby De Valencia',
      description: ['No existen soluciones universales sino Tecnologías Apropiadas para cada contexto económico, ' +
      'organizativo, cultural y ecológico, en el cuál el elemento fundamental para su selección es el impacto ' +
      'ambiental. Esta realidad hace necesaria la identificación del estado del arte de las Tecnologías Apropiadas, ' +
      'y de un análisis comparativo que propicie el intercambio de experiencias que sume esfuerzos sobre la ' +
      'materia en la región amazónica.',
        'Este trabajo argumenta a favor del enfoque integral para atender problemas de construcción, saneamiento ' +
        'básico ambiental –manejo de basuras, disposición de excretas, aguas servidas y energías alternas en áreas ' +
        'marginadas de la Amazonia- por medio de Tecnologías Apropiadas y Apropiables, empleando diversas ' +
    ...
    },
    {
      ...
      author: '',
      description: ['A través de la Base de Datos, en esta primera fase, se ofrece información sobre algunas de las ' +
      'Tecnologías Apropiadas desarrolladas en la Amazonia de Bolivia, Brasil, Colombia y Venezuela, de ' +
      'Profesionales, Técnicos e Instituciones y Proyectos desarrollados con las mismas.',
        'Esta información está dirigida principalmente a los Grupos Comunitarios, Técnicos y Profesionales , ' +
    ...
    },
    {
      ...
      'ambiental y energías alternas.',
      author: '',
      description: ['Con el objeto de sistematizar las experiencias sobre el estado actual de las Tecnologías ' +
      'Apropiadas, y sus actores de desarrollo en los 8 países amazónicos, FUNDABITAT estructuró una Base de Datos ' +
      'Referencial y Relacional de Tecnologías Apropiadas en la Amazonia , sobre Construcción, Saneamiento Básico ' +
    ...
    },
    {
      ...
      author: '',
      description: ['Este singular juego permitirá a los educadores, aplicar diversas estrategias, para enseñar y ' +
      'aprender con el Patrimonio Cultural Arqueológico. Las cartas que contiene, permiten convertir el juego en ' +
      'una experiencia educativa, en ellas encontrará información sobre las Manifestaciones Rupestres venezolanas ' +
      'y los estados donde se ubican.',
        'Estudiantes, educadores y público en general de todas las edades, podrán entrar al mundo de las ' +
    ...
    },
    {
      ...
      author: '',
      description: ['A través de ruedas giratorias, este juego didáctico propone un recorrido temático por la ' +
      ...
      ' a través de las Manifestaciones Rupestres.',
        'FUNDABITAT, 2012'],
      image: 'assets/images/publications/rueda-mundo.png'
    },
    {
      title: 'CD - Memoria Institucional TRATADO DE COOPERACIÓN AMAZÓNICA Publicaciones 1990-1999',
      author: '',
      description: ['Este CD-ROM contiene las publicaciones de la Secretaría Pro Tempore del Tratado de Cooperación ' +
